...
_KEY_VARS = ("GEMINI_API_KEY", "GOOGLE_API_KEY", "OPENAI_API_KEY", "OPENAI_BASE_URL",
             ...
             "OLLAMA_BASE_URL", "OLLAMA_API_KEY", "AWS_PROFILE", "AWS_REGION",
...
def _run(repo: Path, *extra: str):
    ...
    # Keep this no-key scenario independent of whether the test host has the
    # optional codex-cli backend installed.
    env["PATH"] = ""
